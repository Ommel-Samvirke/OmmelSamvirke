...
public class HeadlineBlockDataTests : PagesBaseTestModel
{
    ...
    public void Can_Create_HeadlineBlockData_With_Valid_Data()
    {
        ...
        HeadlineBlockData headlineBlockData = new(DefaultHeadlineBlock, headline, DefaultPage);
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(headlineBlockData.Page, Is.EqualTo(DefaultPage));
        });
    }
    ...
    public void Should_Throw_Exception_When_ContentBlock_Is_Null()
    {
        ...
        Assert.That(() => new HeadlineBlockData(nullContentBlock, headline, DefaultPage), Throws.ArgumentException);
    }
    ...
    public void Should_Throw_Exception_When_Headline_Is_Empty()
    {
        ...
        Assert.That(() => new HeadlineBlockData(DefaultHeadlineBlock, headline, DefaultPage), Throws.ArgumentException);
    }
